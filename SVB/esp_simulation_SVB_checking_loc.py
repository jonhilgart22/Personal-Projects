...
if __name__ == "__main__":
    ...
    with open('data-evidence-checking-loc/time_series_all_clients', 'wb') as fp:
        pickle.dump(times_series_all_clients, fp)
    with open('data-evidence-checking-loc/times_series_cumulative_clients', 'wb') as fp:
        pickle.dump(times_series_cumulative_clients, fp)
    # products
    with open('data-evidence-checking-loc/time_series_money_market_bonus', 'wb') as fp:
        pickle.dump(time_series_money_market_bonus, fp)
    with open('data-evidence-checking-loc/time_series_esp_collateral_mma ', 'wb') as fp:
        pickle.dump(time_series_esp_collateral_mma, fp)
    with open('data-evidence-checking-loc/time_series_esp_cash_management', 'wb') as fp:
        pickle.dump(time_series_esp_cash_management , fp)
    with open('data-evidence-checking-loc/time_series_esp_fx', 'wb') as fp:
        pickle.dump(time_series_esp_fx , fp)
    with open('data-evidence-checking-loc/time_series_esp_letters_of_credit ', 'wb') as fp:
        pickle.dump(time_series_esp_letters_of_credit  , fp)
    with open('data-evidence-checking-loc/time_series_esp_enterprise_sweep', 'wb') as fp:
        pickle.dump(time_series_esp_enterprise_sweep  , fp)
    with open('data-evidence-checking-loc/time_series_esp_checking', 'wb') as fp:
        pickle.dump(time_series_esp_checking , fp)
    # GP
    with open('data-evidence-checking-loc/time_series_esp_money_market_bonus_total_weekly_rev', 'wb') as fp:
        pickle.dump(time_series_esp_money_market_bonus_total_weekly_rev, fp)
    with open('data-evidence-checking-loc/time_series_esp_money_market_bonus_rev_per_customer', 'wb') as fp:
        pickle.dump(time_series_esp_money_market_bonus_rev_per_customer,fp)
    with open('data-evidence-checking-loc/time_series_esp_collateral_mma_total_weekly_rev', 'wb') as fp:
        pickle.dump(time_series_esp_collateral_mma_total_weekly_rev , fp)
    with open('data-evidence-checking-loc/time_series_esp_collateral_mma_rev_per_customer', 'wb') as fp:
        pickle.dump(time_series_esp_collateral_mma_rev_per_customer , fp)
    with open('data-evidence-checking-loc/time_series_esp_cash_management_total_weekly_rev', 'wb') as fp:
        pickle.dump(time_series_esp_cash_management_total_weekly_rev  , fp)
    with open('data-evidence-checking-loc/time_series_esp_cash_management_rev_per_customer', 'wb') as fp:
        pickle.dump(time_series_esp_cash_management_rev_per_customer   , fp)
    with open('data-evidence-checking-loc/time_series_esp_fx_total_weekly_rev', 'wb') as fp:
        pickle.dump(time_series_esp_fx_total_weekly_rev , fp)

    with open('data-evidence-checking-loc/time_series_esp_fx_rev_per_customer', 'wb') as fp:
        pickle.dump(time_series_esp_fx_rev_per_customer, fp)
    with open('data-evidence-checking-loc/time_series_esp_letters_of_credit_total_weekly_rev', 'wb') as fp:
        pickle.dump(time_series_esp_letters_of_credit_total_weekly_rev, fp)
    with open('data-evidence-checking-loc/time_series_esp_letters_of_credit_rev_per_customer', 'wb') as fp:
        pickle.dump(time_series_esp_letters_of_credit_rev_per_customer, fp)
    with open('data-evidence-checking-loc/time_series_esp_enterprise_sweep_total_weekly_rev', 'wb') as fp:
        pickle.dump(time_series_esp_enterprise_sweep_total_weekly_rev , fp)
    with open('data-evidence-checking-loc/time_series_esp_enterprise_sweep_rev_per_customer', 'wb') as fp:
        pickle.dump(time_series_esp_enterprise_sweep_rev_per_customer  , fp)
    with open('data-evidence-checking-loc/time_series_esp_checking_total_weekly_rev', 'wb') as fp:
        pickle.dump(time_series_esp_checking_total_weekly_rev , fp)
    with open('data-evidence-checking-loc/time_series_esp_checking_rev_per_customer', 'wb') as fp:
